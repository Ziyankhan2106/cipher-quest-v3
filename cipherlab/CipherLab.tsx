      ...
      {user && (
        <nav className="relative w-full shrink-0 z-40 pointer-events-none h-16 md:h-28">
          ...
          <div className="absolute top-0 left-0 z-50 pointer-events-auto">
            ...
            <button onClick={() => view === 'dash' ? navigate('/dashboard') : setView('dash')} className="hidden lg:flex w-28 h-28 bg-[#00f2ff] hover:bg-white transition-colors cursor-pointer group items-start justify-start pl-6 pt-6 shadow-[0_0_30px_#00f2ff] outline-none" style={{ clipPath: 'polygon(0 0, 100% 0, 0 100%)' }}>
            ...
            <button onClick={() => view === 'dash' ? navigate('/dashboard') : setView('dash')} className="flex lg:hidden absolute top-4 left-4 p-2 border border-[#00f2ff]/30 rounded bg-[#00f2ff]/10 text-[#00f2ff] shadow-md">
